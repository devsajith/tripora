  ...
  return (
    <div className="flex flex-col min-h-screen bg-surface">
      ...
      <main className="flex-grow pt-16">
        ...
        {/* ========================================================================= */}
        <section className="py-10 px-margin-mobile md:px-margin-desktop bg-surface">
          <div className="max-w-container-max-width mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Card 01 */}
              <div className="bg-gradient-to-b from-teal-700 to-emerald-900 rounded-3xl p-5 sm:p-6 text-white relative overflow-hidden shadow-lg border border-teal-600/30 flex flex-col justify-between group hover:-translate-y-1 transition-all duration-300">
                <div className="w-12 h-12 rounded-full bg-white/95 text-teal-800 flex items-center justify-center mb-4 shadow-md">
                  <span className="material-symbols-outlined text-xl">location_on</span>
                </div>
                <div>
                  <span className="font-sans text-3xl sm:text-4xl font-extrabold text-white/25 block mb-1">01</span>
                  <h3 className="font-sans text-lg sm:text-xl font-bold mb-1.5 text-white">Choose Destination</h3>
                ...
                <div className="pt-3 border-t border-white/15 flex items-center gap-2 text-[11px] font-bold text-teal-200 uppercase tracking-wider">
              ...
              {/* Card 02 */}
              <div className="bg-gradient-to-b from-sky-600 to-teal-800 rounded-3xl p-5 sm:p-6 text-white relative overflow-hidden shadow-lg border border-sky-400/30 flex flex-col justify-between group hover:-translate-y-1 transition-all duration-300">
                <div className="w-12 h-12 rounded-full bg-white/95 text-sky-800 flex items-center justify-center mb-4 shadow-md">
                  <span className="material-symbols-outlined text-xl">payments</span>
                </div>
                <div>
                  <span className="font-sans text-3xl sm:text-4xl font-extrabold text-white/25 block mb-1">02</span>
                  <h3 className="font-sans text-lg sm:text-xl font-bold mb-1.5 text-white">Select Package</h3>
                  <p className="font-sans text-xs text-white/80 leading-relaxed mb-4">
                    Choose the ideal 7-Day, 3-Day or 5-Day itinerary for your budget, family size, and preferred travel dates.
                  </p>
                </div>
                <div className="pt-3 border-t border-white/15 flex items-center gap-2 text-[11px] font-bold text-sky-200 uppercase tracking-wider">
              ...
              {/* Card 03 */}
              <div className="bg-gradient-to-b from-emerald-800 to-teal-950 rounded-3xl p-5 sm:p-6 text-white relative overflow-hidden shadow-lg border border-emerald-700/30 flex flex-col justify-between group hover:-translate-y-1 transition-all duration-300">
                <div className="w-12 h-12 rounded-full bg-white/95 text-emerald-800 flex items-center justify-center mb-4 shadow-md">
                  <span className="material-symbols-outlined text-xl">luggage</span>
                </div>
                <div>
                  <span className="font-sans text-3xl sm:text-4xl font-extrabold text-white/25 block mb-1">03</span>
                  <h3 className="font-sans text-lg sm:text-xl font-bold mb-1.5 text-white">Enjoy Your Trip</h3>
                  <p className="font-sans text-xs text-white/80 leading-relaxed mb-4">
                    Pack your bags and get ready for an unforgettable Kerala journey with our dedicated AC vehicle &amp; driver.
                  </p>
                </div>
                <div className="pt-3 border-t border-white/15 flex items-center gap-2 text-[11px] font-bold text-emerald-200 uppercase tracking-wider">
        ...
        {/* ========================================================================= */}
        <section id="destinations" className="py-10 px-margin-mobile md:px-margin-desktop bg-surface-container-lowest border-t border-emerald-900/10 relative">
          <div className="max-w-container-max-width mx-auto">
            {/* Section Header */}
        ...
        {/* ========================================================================= */}
        <section id="itinerary" className="py-10 px-margin-mobile md:px-margin-desktop bg-surface border-y border-emerald-900/10">
          <div className="max-w-container-max-width mx-auto">
              ...
              {allPackages.map((pkg) => (
                ...
                >
                  <div className="p-5">
                    ...
                    <h3 className="font-sans text-lg font-bold text-primary mb-1 group-hover:text-emerald-800 transition-colors">
                      {pkg.title}
                    </h3>
                    <p className="font-sans text-xs text-on-surface-variant line-clamp-1 mb-3">
                      {pkg.route}
                    </p>

                    <div className="bg-surface p-2.5 rounded-xl border border-emerald-900/10 mb-4">
                    ...
                    <div className="space-y-1.5 font-sans text-xs text-on-surface-variant mb-4">
            ...
            <div className="text-center">
              <Link
                href="/packages"
                className="inline-flex items-center gap-2 bg-emerald-700 hover:bg-emerald-800 text-white font-sans text-xs uppercase tracking-wider font-bold px-8 py-3.5 rounded-full transition-all shadow-md active:scale-95"
              >
        ...
        {/* ========================================================================= */}
        <section id="contact" className="py-10 px-margin-mobile md:px-margin-desktop bg-surface-container-lowest">
          <div className="max-w-container-max-width mx-auto">
            <div className="bg-emerald-950 text-white rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center border border-emerald-900/40">
              
              {/* Left Contact Info */}
              <div className="lg:col-span-5 space-y-4">
                <div>
                  <span className="text-amber-300 font-sans text-[11px] uppercase tracking-[0.2em] font-bold block mb-1.5">
                    CONTACT / BOOKING
                  </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-3 border-t border-white/15 font-sans text-xs">
                  <a
                    href="tel:+919656464124"
                    className="flex items-center gap-2.5 text-white hover:text-amber-300 transition-colors group"
                  >
                    <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-white/20 flex-shrink-0">
              ...
              <div className="lg:col-span-7 bg-white text-on-surface rounded-2xl p-5 sm:p-7 shadow-lg">
                ...
                {submitted ? (
                  <div className="text-center py-6 space-y-3">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 bg-emerald-700 text-white font-sans text-xs uppercase tracking-wider font-bold px-5 py-2.5 rounded-full hover:bg-emerald-800 transition-colors shadow-sm"
                    >
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-3 font-sans text-xs">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 rounded-full border border-gray-200 focus:outline-none focus:border-emerald-700 text-xs bg-surface"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <select
                          className="w-full px-4 py-2.5 rounded-full border border-gray-200 focus:outline-none focus:border-emerald-700 text-xs bg-surface cursor-pointer"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-2 rounded-xl border border-gray-200 focus:outline-none focus:border-emerald-700 text-xs bg-surface"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1.5">
                      <button
                        type="submit"
                        className="w-full bg-emerald-800 hover:bg-emerald-900 text-white font-bold py-2.5 px-4 rounded-full uppercase tracking-wider text-[11px] transition-colors shadow-sm flex items-center justify-center gap-2"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2.5 px-4 rounded-full uppercase tracking-wider text-[11px] transition-colors shadow-sm flex items-center justify-center gap-2"
                      >
